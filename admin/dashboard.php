             ...
             <div class="card-body">
                 <div class="d-flex d-lg-flex d-md-block align-items-center">
                     <div>
                         <div class="d-inline-flex align-items-center">
                             <h2 class="text-dark mb-1 font-weight-medium">
                                 <?php
                                    ...
                                    $query = mysqli_query($conn, "SELECT COUNT(id) AS total FROM pengguna");
                         ...
                         <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Anggota</h6>
                     </div>
                 ...
                 <div class="d-flex d-lg-flex d-md-block align-items-center">
                     <div>
                         <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">
                             <?php
                                include "../assets/conn/koneksi.php";
                                $query = mysqli_query($conn, "SELECT COUNT(id) AS total FROM buku");
                                $result = mysqli_fetch_assoc($query);
                                $total = $result['total'];
                                echo $total;
                                ?></h2>
                         <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Buku
                         </h6>
                     </div>
                     <div class="ml-auto mt-md-3 mt-lg-0">
                     ...
                     <div>
                         <div class="d-inline-flex align-items-center">
                             <h2 class="text-dark mb-1 font-weight-medium">
                                 <?php
                                    include "../assets/conn/koneksi.php";
                                    $query = mysqli_query($conn, "SELECT COUNT(id) AS total FROM peminjaman");
                                    $result = mysqli_fetch_assoc($query);
                                    $total = $result['total'];
                                    echo $total;
                                    ?>
                             ...
                             <span class="badge bg-danger font-12 text-white font-weight-medium badge-pill ml-2 d-md-none d-lg-block">
                                 <?php
                                    ...
                                    $query = mysqli_query($conn, "SELECT COUNT(id) AS total FROM pengembalian");
                                    $result = mysqli_fetch_assoc($query);
                                    $total = $result['total'];
                                    echo '- ' . $total;
                                    ?>
                     ...
                     <div class="table-responsive">
                         <table id="example" class="display table table-striped table-bordered table-hover">
                             ...
                             <?php
                                include "../assets/conn/koneksi.php";
                                $no = 1;
                                $query = mysqli_query($conn, "SELECT peminjaman.id,pengguna.id as id_pengguna, pengguna.nama_pengguna,pengguna.alamat,pengguna.email,buku.id as id_buku,buku.foto, buku.judul, peminjaman.tanggal_pinjam, peminjaman.status_peminjaman 
                                FROM peminjaman 
                                ...
                                ?>
                                 <tr>
                                     ...
                                     <td>
                                         <a href="backend/scr_konfirmasi_peminjaman.php?id_pinjam=<?php echo $d['id']; ?>" class="btn btn-warning btn-block"><i class="fas fa-check text-white"></i></a>
