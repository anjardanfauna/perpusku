         ...
         <div class="card col-lg">
             <div class="card-body">
                 <?php
                    ...
                    $result = mysqli_query($conn, "SELECT ulasan_buku.id_pengguna,ulasan_buku.id_buku,ulasan_buku.ulasan,buku.judul,buku.foto,pengguna.nama_pengguna,ulasan_buku.rating FROM ulasan_buku INNER JOIN buku ON ulasan_buku.id_buku = buku.id INNER JOIN pengguna ON ulasan_buku.id_pengguna=pengguna.id");
